...
def _init():
    ...
    setup_logger('userslog', r'simulate/static/log/users.log')
    setup_logger('ruleslog', r'simulate/static/log/rules.log')
    setup_logger('deviceslog', r'simulate/static/log/devices.log')
